...
HD_PWD='C:/Users/Han/Desktop/Naozhong/Naozhong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm_improve.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alarm_improve.tcl -notrace
