...
HD_PWD='C:/Users/Han/Desktop/Naozhong/Naozhong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm_improve.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alarm_improve.tcl
